...
Revision ID: 61174710757d
Revises: 
Create Date: 2026-08-18 20:43:40.109881
...
def upgrade() -> None:
    ...
    op.create_index('idx_audit_table_name', 'audit_logs', ['table_name'], unique=False)
    ...
    sa.Column('status', sa.Enum('SCHEDULED', 'FULLY_BOOKED', 'IN_PROGRESS', 'COMPLETED', 'CANCELLED', name='schedulestatus'), nullable=True),
...
def downgrade() -> None:
    ...
    op.drop_index('idx_audit_table_name', table_name='audit_logs')
